...
//     const relations: Array<{from: string; to: string; fromField: string; toField: string; fromCardinality: string; toCardinality: string}> = [];
...
//         models[modelName].push({ fieldName, fieldType, isPrimaryKey, isUnique });
...
//                 toCardinality 
//               });
//               addDebugLog(`Found relation from ${modelName}.${fromField} to ${targetModel}.${toField}`);
//             }
//           }
//         }
//       }
...
//         const keyIndicator = field.isPrimaryKey ? "PK" : field.isUnique ? "UK" : "";
//         mermaidCode += `  ${field.fieldType} ${field.fieldName}${keyIndicator ? ` ${keyIndicator}` : ""}\n`;
//       });
//       mermaidCode += '}\n\n';
//     }
...
//       mermaidCode += `${relation.from} "${relation.fromCardinality}" --> "${relation.toCardinality}" ${relation.to} : ${relation.fromField}\n`;
//     });
