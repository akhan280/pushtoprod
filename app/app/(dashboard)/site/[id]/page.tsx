...
import { LocalSiteData, Section } from "../../../../../components/site/site-interfaces";
import { SiteRender } from "../../../../../components/site/builder";
import { testLocalSiteData } from "./testData";

export default async function SiteBuilder({
  params,
}: {
  params: { id: string };
}) {
